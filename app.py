...
def create_app():
    ...
    CORS(app, resources={r"/*": {"origins": "https://dream-me-moir-xhefris-projects.vercel.app/"}}, 
    ...
    def add_cors_headers(response):
        response.headers["Access-Control-Allow-Origin"] = "https://dream-me-moir-xhefris-projects.vercel.app/"
